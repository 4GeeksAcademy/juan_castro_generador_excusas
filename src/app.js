...
window.onload = function () {
  ...
  let excusa = who[aleatorioWho] + " " + action[aleatorioAction] + " " + what[aleatorioWhat] + " " + when[aleatorioWhen]
  let element = document.querySelector("#excuse")
  element.innerText = excusa

  console.log("Hello boys from the console!");
};
